...
namespace Checkers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("MW09 has: " + gameboard.WhatPossibleJumpsCanBeMadeByGivenManPiece("MW09") + "\n");
            Console.WriteLine("MB03 has: " + gameboard.WhatPossibleJumpsCanBeMadeByGivenManPiece("MB03") + "\n");
            Console.WriteLine("MB12 has: " + gameboard.WhatPossibleJumpsCanBeMadeByGivenManPiece("MB12") + "\n");
